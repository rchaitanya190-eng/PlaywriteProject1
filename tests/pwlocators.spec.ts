...
await page.goto("file:///E:/IT/Learning/PlayWright%20-%20TypeScript/Playwright%20Using%20TypeScript%20(End%20to%20End%20Web%20Automation%20Testing)/02%20Understanding%20Playwright%20Locators%20(Built-in)/ClassDemos/ClassDemos/app.html")
//await page.goto("http://127.0.0.1:5500/tests/app.html");
    ...
    await expect(page.getByTitle("Home page link")).toHaveText("Home"); //checks link is having text or not
